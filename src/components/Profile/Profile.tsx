  ...
  return (
    <div id='profile-page' className='w-full flex flex-row h-full lg:px-10'>
        <div className="w-full flex flex-row h-full overflow-hidden relative">
            ...
            <div 
                ref={popupRef}
                className="sidebar-toggle w-64 absolute top-0 left-0 2xl:static 2xl:w-1/5 2xl:hidden flex flex-col justify-between h-full bg-background-darker-2 p-3 shadow-r-harder"
                style={
                    sectionToggle?{
            ...
            >
                ...
                <div className="w-fit h-full absolute left-60 top-0 flex items-center">

                    <button className='rounded-full bg-accent-lighter-2 text-3xl text-primary p-2 shadow-r-harder ' onClick={()=>setSectionToggle(!sectionToggle)}>
                        <AiOutlineRight 
                ...
                <div className="content-wrapper w-full flex flex-col justify-start gap-10 pl-2">
                        ...
                        <div className="content w-full flex flex-col sm:flex-row items-center justify-start">
                            ...
                            <div className="information w-full sm:w-8/12 lg:w-9/12 flex flex-col gap-5 sm:gap-10 pt-3 sm:pt-0 sm:pl-5">
                                <span id="name" className='w-full'>
                                    <p className="text-3xl text-center sm:text-left lg:text-5xl font-extrabold tracking-wide">Nguyễn Tuấn Vinh</p>
                                </span>
                                <div className="personal-infor w-full flex flex-col gap-2">

                                    <span id="phone" className="flex items-start gap-2 text-md lg:text-xl tracking-wide">
                                        <AiFillPhone className="text-2xl text-primary"/>
                                        <p>0793191854</p>
                                    </span>
                                    <span id="email" className="flex items-start gap-2 text-md lg:text-xl tracking-wide">
                                        <AiFillMail className="text-2xl text-primary"/>
                                        <p>nguyentuanvinh1222@gmail.com</p>
                                    </span>
                                    <span id="birthday" className="flex items-start gap-2 text-md lg:text-xl tracking-wide">
                                        <FaBirthdayCake className="text-2xl text-primary"/>
                                        <p>12/02/2001</p>
                                    </span>
                                    <span id="address" className="flex items-start gap-2 text-md lg:text-xl tracking-wide">
                        ...
                        <div className="job-tags-wrapper flex flex-wrap gap-3">
                            {
                                JOB_TAG.map((tag,index)=>{
                                    return(
                                        <div key={`job-tag-${index}`} id={`job-tag-${index}`} className="job-tag px-4 lg:px-7 py-1 lg:py-3 rounded-full bg-accent-lighter-3">
                                            <p className='text-primary font-bold text-base lg:text-lg'>{tag}</p>
                                        </div>
                                    )
                                })
                            }
                            ...
                            {JOBS.map((job,index)=>{
                                return(
                                    <div key={`job-${index}`} className="w-full flex flex-col items-center lg:items-stretch lg:flex-row bg-background-lighter-1 shadow-b-harder">
                                        ...
                                        <div className="business-photo w-8/12 lg:w-4/12 py-3 lg:py-0 flex items-center justify-center bg-white">
                                            <Image
                                        ...
                                        <div className="information w-full lg:w-8/12 flex flex-col gap-10 p-3">
                                            <span id="bussiness-name" className='w-full flex justify-center items-center py-2 bg-accent-lighter-3 rounded-full'>
                                                <p className="xl:text-xl 2xl:text-2xl tracking-wide text-background text-center">{job.Form} tại <b className='font-bold text-primary'>{job.BusinessName}</b></p>
                                            </span>
                                            <div className="personal-infor w-full flex flex-col gap-2">

                                                <span id="position" className="flex w-full items-start gap-2 text-sm sm:text-lg 2xl:text-xl tracking-wide">
                                                    <p className="w-1/4">
                                                        Vi trí:
                                                    </p>
                                                    <p className='w-3/4'>
                                                ...
                                                <span id="duration" className="flex items-start gap-2 text-sm sm:text-lg 2xl:text-xl tracking-wide">
                                                    <p className="w-1/4">
                                                        Thời gian:
                                                    </p>
                                                    <p className='w-3/4'>
                                                ...
                                                <span id="leader" className="flex items-start gap-2 text-sm sm:text-lg 2xl:text-xl tracking-wide">
                                                    <p className="w-1/4">
                                                        Leader:
                                                    </p>
                                                    <p className='w-3/4'>
                                                ...
                                                <span id="feedback" className="flex items-start gap-2 text-sm sm:text-lg 2xl:text-xl tracking-wide">
                                                    <p className="w-1/4">
                                                        Nhận xét
                                                    </p>
                                                    <p className='w-3/4'>
                                        ...
                                        <div key={`education-${index}`} id={`education-${index}`} className='w-full flex items-center bg-background-lighter-2 p-2 shadow-b-harder'>
                                            ...
                                            <div className="information w-6/12 flex flex-col gap-10 pl-5">
                                                <span id="education-content" className='w-full'>
                                                    <p className="tracking-wide text-sm md:text-xl">{education.content}</p>
                                                </span>
                                            </div>
                                        </div>
                                    )
                    ...
                    <section id="hobbies" className='w-full flex flex-col gap-5 p-5 bg-background-darker-2 shadow-b-harder'>
                        ...
                        <div className="content w-full flex flex-wrap justify-start gap-3">
                            <div className="hobbie flex items-center text-sm lg:text-xl gap-2 px-5 py-2 bg-accent-lighter-3 text-background rounded-full border-primary border-2">
                                <BiSolidPalette/>
                                Vẽ
                            </div>
                            <div className="hobbie flex items-center text-sm lg:text-xl gap-2 px-5 py-2 bg-accent-lighter-3 text-background rounded-full border-primary border-2">
                        ...
                        <div className="content w-full flex flex-wrap justify-start gap-3">
                            {POINT_OF_VIEW.map((quote,index)=>{
                                return(
                                    ...
                                    <div key={`quote-${index}`} id={`quote-${index}`} className="hobbie flex items-center text-base lg:text-xl gap-2 px-5 py-2 bg-accent-lighter-3 text-background rounded-full border-primary border-2">
                                        <p>{`"${quote}"`}</p>
                                    </div>
                                )
                            })}
